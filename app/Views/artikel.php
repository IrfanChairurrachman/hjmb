                ...
                <?php $nomor = 0; foreach($article as $key => $row){ ?>
                    <article class="blog_item">
                        <div class="blog_item_img">
                            <img class="card-img rounded-0" src="<?php echo base_url('uploads/'.$row['article_image']) ?>" alt="">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block" href="<?php $slug = str_replace(' ', '_', $row['article_title']);echo base_url('artikel/'.$row['article_id'].'/'.$slug) ?>">
                                <h2><?php echo $row['article_title']; ?></h2>
                            </a>
                            <p><?php echo $row['article_content']; ?></p>
                            <ul class="blog-info-link">
                                <li><i class="fa fa-user"></i><?php echo $row['article_author']; ?></li>
                            </ul>
                        </div>
                    </article>
                <?php } ?>
